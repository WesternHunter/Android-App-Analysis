# 反编译.a文件是执行ida64 -B D:/apk/test1-111-111\5DE3E0——————D00\lib\arm64-v8a\libmono-btls-shared.a
# ida64 -S -Amyidc1.idc D:/apk/test1-111-111\5DE3E0——————D00\lib\arm64-v8a\libmono-btls-shared.a
import configparser
import os
import shutil
import subprocess
...
def execute_so_files(so_ida):
    ...
    for file in so_ida:
        ...
        time.sleep(2)
        filei64 = file.replace('.a', '.i64')
        print(filei64)
        fileasm = file.replace('.a', '.asm')
        print(fileasm)
        i = 0
...
def execute_so_files_idc(so_ida):
    ...
    for file in so_ida:
        ...
        print(cmd_str)
        # file当前是.a文件 D:/apk/test1-111-111\5DE3E0——————D00\lib\arm64-v8a\libmono-btls-shared.a
        print(file)
...
def file_so_ida(apk_craw_file):
    ...
    for root1 in apk_craw_file:
        ...
        # print(len(all_files))
        so_f = find_so_files(
            all_files)  # D:/apk/test1-111-111\5DE3E095A96BFF5760D2CD9DD48F1FC31E193850AE84EEB17C7E53300B678D00\lib\arm64-v8a\libmono-native.a
        print(len(so_f))
        if len(so_f) != 0:
